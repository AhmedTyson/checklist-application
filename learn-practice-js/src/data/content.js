export const contentData = [
    ...
    items: [
      {
        ...
        code: "const car = { \n  make: 'Toyota', \n  year: 2020 \n};",
        prompt: "Create an object representing yourself with name, age, isLearning, and a greet() method.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Write a function that takes an object and a key name (string) and returns the value. You must use bracket notation.",
        resources: [
          { label: "MDN: Property Accessors", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Property_accessors" },
          { label: "javascript.info: Property Access", url: "https://javascript.info/object#square-brackets" },
        ],
      },
      {
        title: "Mutation",
        ...
        prompt: "Create an object, freeze it with Object.freeze(), then try to modify it. Observe what happens (silent fail in non-strict mode).",
        resources: [
          { label: "MDN: Object.freeze", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/freeze" },
          { label: "javascript.info: Object References", url: "https://javascript.info/object-copy" },
        ],
      },
      {
        ...
        prompt: "Create a calculator object with add, subtract, and result methods that chain together.",
        resources: [
          { label: "MDN: Method Definitions", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Method_definitions" },
          { label: "javascript.info: Object Methods", url: "https://javascript.info/object-methods" },
        ],
      },
      {
        ...
        prompt: "Destructure an API response object: extract the data, status, and rename 'error' to 'errorMessage' with a default of null.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Clone a user object and override the 'role' property to 'admin' using spread, without modifying the original.",
        resources: [
          { label: "MDN: Spread Syntax", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax" },
          { label: "javascript.info: Spread", url: "https://javascript.info/rest-parameters-spread#spread-syntax" },
        ],
      },
      {
        ...
        prompt: "Write a function that safely extracts a user's first hobby from { hobbies: ['coding'] } — handle missing hobbies array gracefully.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Create an array of 5 items, then set .length = 3. Log the array and observe the truncation.",
        resources: [
          { label: "Exercism: Arrays", url: "https://exercism.org/tracks/javascript/concepts/arrays" },
      ...
      },
      {
        ...
        prompt: "Swap two variables a=1 and b=2 using array destructuring in one line, without a temp variable.",
        resources: [
          { label: "MDN: Array Destructuring", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment#array_destructuring" },
          { label: "javascript.info: Array Destructuring", url: "https://javascript.info/destructuring-assignment#array-destructuring" },
        ],
      },
      {
        title: "Spread Arrays",
        ...
        prompt: "Use spread to add an item to the beginning and end of an array without using unshift() or push().",
        resources: [
          { label: "MDN: Spread (Arrays)", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax#spread_in_array_literals" },
          { label: "javascript.info: Spread", url: "https://javascript.info/rest-parameters-spread" },
        ],
      },
      {
        ...
        code: "const arr = [1];\narr.push(2);    // [1, 2]\narr.pop();      // [1]\narr.unshift(0); // [0, 1]\narr.shift();    // [1]",
        prompt: "Implement a simple stack (LIFO) using just push and pop. Then implement a queue (FIFO) using push and shift.",
        resources: [
          { label: "MDN: Array.push", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push" },
          { label: "Video: Stack vs Queue", url: "https://www.youtube.com/watch?v=wjI1WNcIntg" },
        ],
      },
      {
        ...
        prompt: "Use splice to remove the 3rd item from an array and insert two new items in its place.",
        resources: [
          { label: "MDN: Slice", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/slice" },
          { label: "MDN: Splice", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/splice" },
        ],
      },
      {
        ...
        prompt: "Use Object.entries() with forEach to log 'key: value' for every property in an object.",
        resources: [
          { label: "MDN: Object.keys", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/keys" },
          { label: "javascript.info: Object.keys/values/entries", url: "https://javascript.info/keys-values-entries" },
        ],
      },
      {
        title: "for...of / for...in",
        ...
        prompt: "Use for...of to iterate a string character by character. Then use for...in to iterate an object and build a query string 'key=value&key=value'.",
        resources: [
          { label: "MDN: for...of", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for...of" },
          { label: "MDN: for...in", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for...in" },
        ],
      },
      {
        title: "Map",
        ...
        prompt: "Create a Map that uses DOM elements as keys and stores their original colors as values. Use it to implement an undo-color feature.",
        resources: [
          { label: "MDN: Map", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map" },
          { label: "javascript.info: Map", url: "https://javascript.info/map-set#map" },
        ],
      },
      {
        title: "Set",
        ...
        prompt: "Write a function that takes two arrays and returns their unique combined values (union) using Set.",
        resources: [
          { label: "MDN: Set", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set" },
          { label: "javascript.info: Set", url: "https://javascript.info/map-set#set" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        prompt: "Use forEach to create a <li> element for each item in an array and append it to a <ul>.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Map an array of user objects [{name, age}] to an array of HTML card strings using template literals.",
        resources: [
          { label: "MDN: map", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map" },
          { label: "Scrimba: Array map", url: "https://scrimba.com/learn/javascript" },
        ],
      },
      {
        title: "filter",
        ...
        prompt: "Filter an array of product objects to find only those in stock (inStock: true) AND under $50.",
        resources: [
          { label: "MDN: filter", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter" },
          { label: "javascript.info: filter", url: "https://javascript.info/array-methods#filter" },
        ],
      },
      {
        title: "reduce",
        ...
        prompt: "Use reduce to count how many times each word appears in an array, returning an object like { hello: 2, world: 1 }.",
        resources: [
          { label: "MDN: reduce", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce" },
          { label: "Video: Reduce in 100 Seconds", url: "https://www.youtube.com/watch?v=tVCZaXHeT-4" },
        ],
      },
      {
        title: "find",
        ...
        prompt: "Write a function findByEmail(users, email) that returns the user object matching the email, or undefined.",
        resources: [
          { label: "MDN: find", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/find" },
          { label: "javascript.info: find", url: "https://javascript.info/array-methods#find-and-findindex" },
        ],
      },
      {
        title: "findIndex",
        ...
        prompt: "Find the index of a todo item by its id, then use splice to replace it with an updated version.",
        resources: [
          { label: "MDN: findIndex", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/findIndex" },
          { label: "javascript.info: findIndex", url: "https://javascript.info/array-methods#find-and-findindex" },
        ],
      },
      {
        title: "some / every",
        ...
        prompt: "Check if a shopping cart has any out-of-stock items (some), and if all items have a valid price (every).",
        resources: [
          { label: "MDN: some", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/some" },
          { label: "MDN: every", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/every" },
        ],
      },
      {
        title: "sort",
        ...
        prompt: "Sort an array of {name, date} objects by date (newest first). Use new Date() for comparison.",
        resources: [
          { label: "MDN: sort", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort" },
          { label: "javascript.info: sort", url: "https://javascript.info/array-methods#sort-fn" },
        ],
      },
      {
        title: "includes",
        ...
        prompt: "Write a function isAllowed(role) that checks if a role is in the allowed list ['admin', 'editor', 'moderator'].",
        resources: [
          { label: "MDN: includes", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes" },
          { label: "javascript.info: includes", url: "https://javascript.info/array-methods#includes" },
        ],
      },
      {
        title: "flat / flatMap",
        ...
        prompt: "Given an array of users where each user has a 'tags' array, use flatMap to get a single array of all unique tags.",
        resources: [
          { label: "MDN: flat", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/flat" },
          { label: "MDN: flatMap", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/flatMap" },
        ],
      },
      {
        ...
        prompt: "Chain filter, map, and reduce: from an array of products, get only in-stock items, extract their prices, and calculate the total.",
        resources: [
          { label: "Video: HOF Chaining", url: "https://www.youtube.com/watch?v=rRgD1yVwIvE" },
          { label: "Exercism: Array Methods", url: "https://exercism.org/tracks/javascript/concepts/array-analysis" },
        ],
      },
    ],
  },
  {
    ...
    description: "Defining behavior, reusable code blocks, and advanced patterns.",
    items: [
      {
        ...
        prompt: "Write a function that calculates Body Mass Index (BMI) given weight (kg) and height (m).",
        resources: [
      ...
      },
      {
        ...
        prompt: "Create two function expressions: one for add and one for subtract. Store them in an object as methods.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Convert a traditional function that uses 'this' inside an object to an arrow function and observe how 'this' breaks.",
        resources: [
          { label: "MDN: Arrow Functions", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions" },
          { label: "javascript.info: Arrow Functions", url: "https://javascript.info/arrow-functions-basics" },
        ],
      },
      {
        ...
        prompt: "Write a one-liner arrow function that takes an array and returns its length. Then write one that returns an object with {count: array.length}.",
        resources: [
          { label: "javascript.info: Arrow Shortcuts", url: "https://javascript.info/arrow-functions-basics" },
          { label: "MDN: Arrow Functions", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions#function_body" },
        ],
      },
      {
        ...
        prompt: "Create a createUser function with defaults: role='user', active=true, createdAt=new Date().",
        resources: [
          ...
          { label: "javascript.info: Default Values", url: "https://javascript.info/function-basics#default-values" },
        ],
      },
      {
        ...
        prompt: "Create a function that takes a required 'action' string and any number of 'items', then logs '[action]: item1, item2, ...'.",
        resources: [
          { label: "MDN: Rest Parameters", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/rest_parameters" },
          { label: "javascript.info: Rest Parameters", url: "https://javascript.info/rest-parameters-spread#rest-parameters" },
        ],
      },
      {
        ...
        prompt: "Write a higher-order function 'unless(condition, thenDo)' that calls thenDo() only when condition is false.",
        resources: [
          { label: "javascript.info: Higher-Order Functions", url: "https://javascript.info/function-expressions#callback-functions" },
          { label: "Exercism: Higher-Order Functions", url: "https://exercism.org/tracks/javascript/concepts/callbacks" },
        ],
      },
      {
        title: "Callbacks",
        ...
        prompt: "Write a function processArray(arr, callback) that applies callback to each item and returns a new array of results.",
        resources: [
          { label: "MDN: Callback Function", url: "https://developer.mozilla.org/en-US/docs/Glossary/Callback_function" },
          { label: "javascript.info: Callbacks", url: "https://javascript.info/callbacks" },
        ],
      },
      {
        title: "IIFE",
        ...
        prompt: "Create an IIFE that initializes a counter module with increment(), decrement(), and getCount() methods — all using closure.",
        resources: [
          { label: "MDN: IIFE", url: "https://developer.mozilla.org/en-US/docs/Glossary/IIFE" },
          { label: "javascript.info: IIFE", url: "https://javascript.info/var#iife" },
        ],
      },
      {
        title: "Context (this)",
        ...
        prompt: "Extract a method from an object, assign it to a variable, and call it. Observe how 'this' is lost. Then fix it using bind().",
        resources: [
          { label: "MDN: this", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this" },
          { label: "javascript.info: this", url: "https://javascript.info/object-methods#this-in-methods" },
        ],
      },
      {
        ...
        prompt: "Create a function logInfo() that uses 'this'. Use bind to permanently attach it to a user object, then pass the bound version as a callback to setTimeout.",
        resources: [
          { label: "MDN: bind", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/bind" },
          { label: "javascript.info: call/apply/bind", url: "https://javascript.info/bind" },
        ],
      },
      {
        title: "Recursion",
        ...
        prompt: "Write a recursive function deepFlatten(arr) that flattens a nested array of any depth: [1, [2, [3, [4]]]] → [1, 2, 3, 4].",
        resources: [
          { label: "javascript.info: Recursion", url: "https://javascript.info/recursion" },
          { label: "Exercism: Recursion", url: "https://exercism.org/tracks/javascript/concepts/recursion" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        prompt: "Open DevTools, go to Console, and explore document.body.children. Navigate through the tree to find a specific element.",
        resources: [
          { label: "MDN: DOM Introduction", url: "https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Introduction" },
          { label: "javascript.info: DOM Tree", url: "https://javascript.info/dom-nodes" },
        ],
      },
      {
        title: "Selection",
        ...
        prompt: "Select all links with class 'nav-link' and log their href attributes using querySelectorAll and forEach.",
        resources: [
          { label: "MDN: querySelector", url: "https://developer.mozilla.org/en-US/docs/Web/API/Document/querySelector" },
          { label: "javascript.info: Searching Elements", url: "https://javascript.info/searching-elements-dom" },
        ],
      },
      {
        title: "Text Content",
        ...
        prompt: "Create a function that safely displays user-submitted text in a div using textContent (not innerHTML) to prevent XSS.",
        resources: [
          { label: "MDN: textContent", url: "https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent" },
          { label: "javascript.info: innerHTML", url: "https://javascript.info/basic-dom-node-properties#innerhtml-the-contents" },
        ],
      },
      {
        title: "Styles",
        ...
        prompt: "Write a function that reads the current background color of an element and toggles it between two colors on click.",
        resources: [
          { label: "MDN: HTMLElement.style", url: "https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/style" },
          { label: "javascript.info: Styles", url: "https://javascript.info/styles-and-classes" },
        ],
      },
      {
        title: "Classes",
        ...
        prompt: "Build a dark mode toggle: on button click, toggle a 'dark' class on document.body that changes background and text colors via CSS.",
        resources: [
          { label: "MDN: classList", url: "https://developer.mozilla.org/en-US/docs/Web/API/Element/classList" },
          { label: "javascript.info: Styles and Classes", url: "https://javascript.info/styles-and-classes#classname-and-classlist" },
        ],
      },
      {
        title: "Creation",
        ...
        prompt: "Create a complete card element with an image, title, and description — all in JS. Don't insert it yet.",
        resources: [
          { label: "MDN: createElement", url: "https://developer.mozilla.org/en-US/docs/Web/API/Document/createElement" },
          { label: "javascript.info: Creating Elements", url: "https://javascript.info/modifying-document#creating-an-element" },
        ],
      },
      {
        title: "Insertion",
        ...
        prompt: "Build a todo list: create an input and button. On click, create a new <li> and prepend it to the list.",
        resources: [
          { label: "MDN: append", url: "https://developer.mozilla.org/en-US/docs/Web/API/Element/append" },
          { label: "javascript.info: Modifying Document", url: "https://javascript.info/modifying-document" },
        ],
      },
      {
        title: "Removal",
        ...
        prompt: "Add a 'delete' button to each list item that removes itself from the DOM when clicked.",
        resources: [
          { label: "MDN: remove", url: "https://developer.mozilla.org/en-US/docs/Web/API/Element/remove" },
          { label: "javascript.info: Removing Nodes", url: "https://javascript.info/modifying-document#removal-of-nodes" },
        ],
      },
      {
        title: "Attributes",
        ...
        prompt: "Select all images on a page and add a 'loading=\"lazy\"' attribute to each one using setAttribute.",
        resources: [
          { label: "MDN: setAttribute", url: "https://developer.mozilla.org/en-US/docs/Web/API/Element/setAttribute" },
          { label: "javascript.info: Attributes", url: "https://javascript.info/dom-attributes-and-properties" },
        ],
      },
      {
        ...
        prompt: "Create a list of products where each <li> has data-price and data-category attributes. Write JS that filters visible items by category using dataset.",
        resources: [
          { label: "MDN: data-* attributes", url: "https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes" },
          { label: "javascript.info: Dataset", url: "https://javascript.info/dom-attributes-and-properties#non-standard-attributes-dataset" },
        ],
      },
      {
        title: "DOM Traversal",
        ...
        prompt: "Select the middle item in a list and highlight its previous and next siblings by adding a CSS class.",
        resources: [
          { label: "MDN: Node relationships", url: "https://developer.mozilla.org/en-US/docs/Web/API/Node" },
          { label: "javascript.info: DOM Navigation", url: "https://javascript.info/dom-navigation" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        prompt: "Add a click listener to a button. After 3 clicks, remove the listener so the button no longer responds.",
        resources: [
          { label: "MDN: addEventListener", url: "https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener" },
          { label: "javascript.info: Events", url: "https://javascript.info/introduction-browser-events" },
        ],
      },
      {
        title: "Mouse Events",
        ...
        prompt: "Build a color picker: on mousemove over a div, change its background color based on the cursor's X/Y position.",
        resources: [
          { label: "MDN: MouseEvent", url: "https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent" },
          { label: "javascript.info: Mouse Events", url: "https://javascript.info/mouse-events-basics" },
        ],
      },
      {
        ...
        prompt: "Create a keyboard shortcut: Ctrl+K opens a search bar, Escape closes it.",
        resources: [
          { label: "MDN: KeyboardEvent", url: "https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent" },
          { label: "javascript.info: Keyboard Events", url: "https://javascript.info/keyboard-events" },
        ],
      },
      {
        title: "Form Events",
        ...
        prompt: "Build a live search: listen for 'input' on a text field and filter a list of items as the user types.",
        resources: [
          { label: "MDN: FormData", url: "https://developer.mozilla.org/en-US/docs/Web/API/FormData" },
          { label: "javascript.info: Form Events", url: "https://javascript.info/forms-submit" },
        ],
      },
      {
        ...
        prompt: "Log e.target.tagName inside a parent div's click listener. Click different child elements and observe the output.",
        resources: [
          { label: "MDN: Event Object", url: "https://developer.mozilla.org/en-US/docs/Web/API/Event" },
          { label: "javascript.info: Event Object", url: "https://javascript.info/introduction-browser-events#event-object" },
        ],
      },
      {
        ...
        prompt: "Create 3 nested divs. Add click listeners to all 3. Click the innermost and observe the bubbling order. Then stop propagation at the middle div.",
        resources: [
          { label: "javascript.info: Bubbling", url: "https://javascript.info/bubbling-and-capturing" },
          { label: "MDN: Event Propagation", url: "https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Event_bubbling" },
        ],
      },
      {
        ...
        prompt: "Build a dynamic todo list using a single delegated listener on the <ul>. Handle both 'complete' and 'delete' actions.",
        resources: [
          { label: "javascript.info: Delegation", url: "https://javascript.info/event-delegation" },
          { label: "MDN: Event Delegation", url: "https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Event_bubbling#event_delegation" },
        ],
      },
      {
        ...
        prompt: "Log timestamps for DOMContentLoaded and load events. Observe the time difference on a page with large images.",
        resources: [
          { label: "MDN: DOMContentLoaded", url: "https://developer.mozilla.org/en-US/docs/Web/API/Document/DOMContentLoaded_event" },
          { label: "javascript.info: Page Lifecycle", url: "https://javascript.info/onload-ondomcontentloaded" },
        ],
      },
      {
        ...
        prompt: "Build a 'back to top' button that only appears when the user scrolls past 300px. Use scroll event with debouncing.",
        resources: [
          { label: "MDN: Scroll Event", url: "https://developer.mozilla.org/en-US/docs/Web/API/Element/scroll_event" },
    ...
    items: [
      {
        ...
        prompt: "Predict the output order of: console.log('A'), setTimeout(() => log('B'), 0), Promise.resolve().then(() => log('C')), console.log('D'). Then verify.",
        resources: [
          { label: "Video: Event Loop (Philip Roberts)", url: "https://www.youtube.com/watch?v=8aGhZQkoFbQ" },
      ...
      },
      {
        ...
        prompt: "Build a countdown timer that displays 10, 9, 8... 0, then shows 'Time's up!' and stops the interval.",
        resources: [
          { label: "MDN: setTimeout", url: "https://developer.mozilla.org/en-US/docs/Web/API/setTimeout" },
          { label: "MDN: setInterval", url: "https://developer.mozilla.org/en-US/docs/Web/API/setInterval" },
        ],
      },
      {
        title: "Promises",
        ...
        prompt: "Create a function wait(ms) that returns a Promise that resolves after the given milliseconds. Use it with async/await.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Rewrite a .then().then().catch() chain using async/await with try/catch. Compare readability.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Fetch data from JSONPlaceholder API (/users), handle errors properly (check res.ok), and display the data in a list.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Write an async function that fetches data, shows a loading spinner during the request, and always hides it in finally — even if the request fails.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Save a complex object (with nested arrays) to localStorage using JSON.stringify, then retrieve and parse it back.",
        resources: [
          { label: "MDN: JSON", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON" },
          { label: "javascript.info: JSON", url: "https://javascript.info/json" },
        ],
      },
      {
        title: "Promise.all",
        ...
        prompt: "Fetch user profile and user posts simultaneously using Promise.all. Measure the time vs fetching them sequentially.",
        resources: [
          { label: "MDN: Promise.all", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/all" },
          { label: "javascript.info: Promise.all", url: "https://javascript.info/promise-api#promise-all" },
        ],
      },
      {
        ...
        prompt: "Implement a fetch with a 3-second timeout using Promise.race. If the timeout wins, show an error message.",
        resources: [
    ...
    items: [
      {
        ...
        prompt: "Write three functions that call each other. Use console.trace() in the deepest one to visualize the stack.",
        resources: [
          { label: "MDN: Call Stack", url: "https://developer.mozilla.org/en-US/docs/Glossary/Call_stack" },
          { label: "javascript.info: Execution Context", url: "https://javascript.info/recursion#execution-context-and-stack" },
        ],
      },
      {
        title: "Hoisting",
        ...
        prompt: "Predict the output of code that mixes var, let, and function declarations at different positions. Verify your predictions.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Create a function createMultiplier(factor) that returns a function which multiplies any number by that factor. Make multipliers for 2, 3, and 5.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Create 3 nested functions. In the innermost, access a variable from each level. Then try to access an inner variable from an outer function — observe the error.",
        resources: [
          { label: "javascript.info: Variable Scope", url: "https://javascript.info/closure#lexical-environment" },
      ...
      },
      {
        ...
        prompt: "Write code that uses console.log, setTimeout, Promise.resolve().then(), and queueMicrotask(). Predict the output order, then verify.",
        resources: [
          { label: "Video: Event Loop (Philip Roberts)", url: "https://www.youtube.com/watch?v=8aGhZQkoFbQ" },
          { label: "javascript.info: Event Loop", url: "https://javascript.info/event-loop" },
        ],
      },
      {
        ...
        prompt: "Create a function that takes an object and accidentally mutates it. Then fix it by spreading the object first to create a copy.",
        resources: [
          { label: "javascript.info: Object Copy", url: "https://javascript.info/object-copy" },
          { label: "MDN: Structured Clone", url: "https://developer.mozilla.org/en-US/docs/Web/API/structuredClone" },
        ],
      },
      {
        ...
        prompt: "Create a prototype chain: vehicle → car → electricCar. Add a method to each level and call them all from electricCar.",
        resources: [
          { label: "MDN: Inheritance and the Prototype Chain", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain" },
    ...
    items: [
      {
        ...
        prompt: "Create a 'Product' class with name, price, and quantity. Add methods: getTotalValue(), applyDiscount(percent), and toString().",
        resources: [
      ...
      },
      {
        ...
        prompt: "Create an Animal class, then extend it with Dog and Cat classes. Each should override a speak() method. Test with polymorphism.",
        resources: [
          { label: "MDN: extends", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/extends" },
          { label: "javascript.info: Class Inheritance", url: "https://javascript.info/class-inheritance" },
        ],
      },
      {
        ...
        prompt: "Create a 'Validator' class with static methods: isEmail(str), isStrongPassword(str), and isURL(str).",
        resources: [
          { label: "MDN: static", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/static" },
          { label: "javascript.info: Static Methods", url: "https://javascript.info/static-properties-methods" },
        ],
      },
      {
        ...
        prompt: "Create a Temperature class with value in Celsius. Add a getter 'fahrenheit' that converts, and a setter 'fahrenheit' that converts back.",
        resources: [
          { label: "MDN: get", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/get" },
          { label: "javascript.info: Getters/Setters", url: "https://javascript.info/property-accessors" },
        ],
      },
      {
        ...
        prompt: "Build a 'PasswordManager' class with a private #passwords Map. Add methods: store(site, password), retrieve(site), and list() (shows sites only, not passwords).",
        resources: [
          { label: "MDN: Private Fields", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/Private_properties" },
          { label: "javascript.info: Private Fields", url: "https://javascript.info/private-protected-properties-methods#private" },
        ],
      },
      {
        ...
        prompt: "Create a character builder using composition: combine abilities (canAttack, canHeal, canCast) to create Warrior, Healer, and Mage characters without inheritance.",
        resources: [
          { label: "Video: Composition vs Inheritance", url: "https://www.youtube.com/watch?v=wfMtDGfHWpA" },
    ...
    items: [
      {
        ...
        prompt: "Split a monolithic file into 3 modules: data.js (constants), utils.js (helper functions), app.js (main logic). Wire them together with imports.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Build a theme toggle that saves the user's preference to localStorage and restores it on page reload.",
        resources: [
          { label: "MDN: LocalStorage", url: "https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage" },
          { label: "javascript.info: LocalStorage", url: "https://javascript.info/localstorage" },
        ],
      },
      {
        ...
        prompt: "Build a multi-step form wizard that saves progress to sessionStorage. When the user returns to a step, restore their previous input.",
        resources: [
          { label: "MDN: sessionStorage", url: "https://developer.mozilla.org/en-US/docs/Web/API/Window/sessionStorage" },
          { label: "javascript.info: sessionStorage", url: "https://javascript.info/localstorage#sessionstorage" },
        ],
      },
      {
        title: "Dates",
        ...
        prompt: "Write a function daysUntil(dateString) that returns the number of days between now and a future date. Handle past dates gracefully.",
        resources: [
          { label: "MDN: Date", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date" },
          { label: "javascript.info: Date", url: "https://javascript.info/date" },
        ],
      },
      {
        title: "Math Lib",
        ...
        prompt: "Write a function randomColor() that generates a random hex color string like '#3a7bf2'. Use Math.random and .toString(16).",
        resources: [
          { label: "MDN: Math", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math" },
          { label: "javascript.info: Number Methods", url: "https://javascript.info/number" },
        ],
      },
      {
        ...
        prompt: "Write regex patterns to: (1) validate a phone number, (2) extract all hashtags from a tweet, (3) replace multiple spaces with a single space.",
        resources: [
      ...
      },
      {
        ...
        prompt: "Write code that intentionally triggers each error type (TypeError, ReferenceError, RangeError). Catch each with try/catch and log the error.constructor.name.",
        resources: [
          { label: "MDN: Error Types", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error#error_types" },
          { label: "javascript.info: Custom Errors", url: "https://javascript.info/custom-errors" },
        ],
      },
      {
        ...
        prompt: "Set a breakpoint inside a loop. Use the Watch panel to monitor a variable. Use the Call Stack panel to see which function called the current one.",
        resources: [
          { label: "Chrome: Debugging Guide", url: "https://developer.chrome.com/docs/devtools/javascript/" },
          { label: "javascript.info: Debugging in Chrome", url: "https://javascript.info/debugging-chrome" },
        ],
      },
      {
        ...
        prompt: "Clone a complex nested object using both JSON.parse(JSON.stringify()) and structuredClone(). Include a Date property and compare the results — observe how JSON approach breaks the Date.",
        resources: [
          { label: "MDN: structuredClone", url: "https://developer.mozilla.org/en-US/docs/Web/API/structuredClone" },
          { label: "javascript.info: structuredClone", url: "https://javascript.info/object-copy#structuredclone" },
        ],
      },
      {
        title: "The BOM",
        ...
        prompt: "Build a function that reads the current URL search params (?key=value), modifies one, and updates the URL without reloading using history.pushState.",
        resources: [
          { label: "javascript.info: BOM", url: "https://javascript.info/browser-environment" },
          { label: "MDN: Window", url: "https://developer.mozilla.org/en-US/docs/Web/API/Window" },
        ],
      },
    ],
  },
